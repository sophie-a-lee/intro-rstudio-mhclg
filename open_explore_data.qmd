...
```{r boyfriend meme, echo = FALSE, warning = FALSE, message = FALSE}
library(tidyverse)
...
The first data set we will load is the`generalfs21_EUL.sav` file. This contains general information taken from the English Housing Survey (EHS) from 2021, including a unique identifier, the responders' region, and the tenure type. 
...
Or look at the `dplyr` [cheatsheet](https://rstudio.github.io/cheatsheets/data-transformation.pdf). 
