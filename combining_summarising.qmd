...
Use all available resources, including help files and [cheatsheets](https://rstudio.github.io/cheatsheets/data-transformation.pdf) if you are struggling to find a function to do this.
:::
